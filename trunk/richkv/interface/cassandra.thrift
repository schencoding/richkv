...
struct CfDef {
    ...
    33: optional string delta_function_name,
}
...
service Cassandra {
  ...
  /**
    Get the Delta Column  at the given column_path. If no value is present, NotFoundException is thrown. (This is
    the only method that can throw an exception under non-failure conditions.)
   */            
  ColumnOrSuperColumn get_delta(1:required binary key,
                          2:required binary delta_key,
                          3:required ColumnPath column_path,
                          4:required ConsistencyLevel consistency_level=ConsistencyLevel.ONE)
                      throws (1:InvalidRequestException ire, 2:NotFoundException nfe, 3:UnavailableException ue, 4:TimedOutException te),
                      
   /**
    Make segmented storage for large value.
   */            
  ColumnOrSuperColumn read_chunk(1:required i32 id,
                          2:required binary key,
                          3:required ColumnPath column_path,
                          4:required ConsistencyLevel consistency_level=ConsistencyLevel.ONE)
                      throws (1:InvalidRequestException ire, 2:NotFoundException nfe, 3:UnavailableException ue, 4:TimedOutException te),
                      
  ColumnOrSuperColumn delta_chunk(1:required i32 id,
                          2:required binary key,
                          3:required binary delta_key,
                          4:required ColumnPath column_path,
                          5:required ConsistencyLevel consistency_level=ConsistencyLevel.ONE)
                      throws (1:InvalidRequestException ire, 2:NotFoundException nfe, 3:UnavailableException ue, 4:TimedOutException te),
                      
  void write_chunk(1:required i32 id,
                          2:required binary key,
  ...
  void write_chunk_delta(1:required i32 id,
                          2:required binary key,
                          3:required ColumnParent column_parent,
                          4:required UpdateColumn updatecolumn,
                          5:required ConsistencyLevel consistency_level=ConsistencyLevel.ONE)
                       throws (1:InvalidRequestException ire, 2:UnavailableException ue, 3:TimedOutException te),
                      
  void rename_chunk(1:required i32 oldId,
                          2:required i32 newId,
  ...
  */
  ...
  /**
   * Insert a UpdateColumn at the given column_parent.column_family and optional column_parent.super_column.
   */
  void insert_delta(1:required binary key, 
              2:required ColumnParent column_parent,
              3:required UpdateColumn updatecolumn,
              4:required ConsistencyLevel consistency_level=ConsistencyLevel.ONE)
       throws (1:InvalidRequestException ire, 2:UnavailableException ue, 3:TimedOutException te),
  ...
  */
  ...
  map<string, list<string>> describe_function_versions()
       throws (1: InvalidRequestException ire),
  ...
  FtDef describe_function(1:required string functionName)
    throws (1:NotFoundException nfe, 2:InvalidRequestException ire),   
  ...
  /** adds a delta function. returns the new schema id. */
  string system_add_function(1:required FtDef ft_def)
    throws (1:InvalidRequestException ire, 2:SchemaDisagreementException sde),
