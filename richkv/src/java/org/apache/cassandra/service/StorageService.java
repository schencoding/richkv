...
public class StorageService implements IEndpointStateChangeSubscriber, StorageServiceMBean
{
    ...
    {{
        ...
        put(Verb.DELTA_FUNCTION, Stage.READ);
        put(Verb.TRUNCATE, Stage.MUTATION);
        put(Verb.SCHEMA_CHECK, Stage.MIGRATION);
        put(Verb.FUNCTION_CHECK, Stage.DELTAFUNCTION);
    ...
    public StorageService()
    {
        ...
        MessagingService.instance().registerVerbHandlers(Verb.DELTA_FUNCTION, new DeltaFunctionVerbHandler());
        ...
        MessagingService.instance().registerVerbHandlers(Verb.FUNCTION_CHECK, new FunctionCheckVerbHandler());
